-- ==============================================================
-- TextilQuote Pro - Dependientes Schema Migration (Robust Version)
-- PostgreSQL / Supabase
-- ==============================================================

-- 1. Modificar la restricción de 'role' en terceros para incluir 'dependiente'
-- Se intentan borrar ambas posibles nomenclaturas por si no se renombraron al migrar de 'clients' a 'terceros'
